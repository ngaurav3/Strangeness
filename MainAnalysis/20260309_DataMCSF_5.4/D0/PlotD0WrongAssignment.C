...
int PlotD0WrongAssignment(std::string input = "D0WrongAssignmentHistograms.root",
  ...
  DrawComparison(hNominalNoPionTag, hSwappedNoPionTag,
                 "D^{0} wrong-assignment study, no pion tag",
                 outputDir + "/d0_wrong_assignment_no_pion_tag.pdf");
  DrawComparison(hNominalWithPionTag, hSwappedWithPionTag,
                 "D^{0} wrong-assignment study, with pion tag",
                 outputDir + "/d0_wrong_assignment_with_pion_tag.pdf");
  return 0;
}

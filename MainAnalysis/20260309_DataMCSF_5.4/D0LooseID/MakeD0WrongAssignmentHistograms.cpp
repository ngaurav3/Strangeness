...
int main(int argc, char* argv[]) {
  ...
  TNamed selection("SelectionSummary",
                   Form("D0 LooseID wrong-assignment study: valid D0Reco IDs, D0Reco1Angle<%.4f, "
                        "D0Reco2Angle<%.4f, both RecoGoodTrack==1, both 0.15<=|cos(theta)|<=0.675, "
                        "opposite charge, compare nominal daughter1->K daughter2->pi assignment against "
                        "swapped daughter2->K daughter1->pi assignment, with RecoPIDKaon>=1 on the assumed kaon "
                        "and optional pion-tag selections, "

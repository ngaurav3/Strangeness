...
int PlotD0WrongAssignment(std::string input = "d0_looseid_wrong_assignment_histograms.root",
  ...
  DrawComparison(hNominalNoPionTag, hSwappedNoPionTag,
                 "D^{0} LooseID wrong-assignment study, no pion tag",
                 outputDir + "/d0_looseid_wrong_assignment_no_pion_tag.pdf");
  DrawComparison(hNominalWithPionTag, hSwappedWithPionTag,
                 "D^{0} LooseID wrong-assignment study, with pion tag",
                 outputDir + "/d0_looseid_wrong_assignment_with_pion_tag.pdf");
  return 0;
}
